    <footer class="footer">
        <div class="footer-links">
            <a><?php echo date("Y"); ?> <strong>© osoblive inc.</strong> Wszelkie prawa zastrzeżone</a>
        </div>
        <div class="footer-logo">
            <svg class="svg-logo-footer" version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 523 113"
                width="100">
                <style>
                .svg-logo-footer {
